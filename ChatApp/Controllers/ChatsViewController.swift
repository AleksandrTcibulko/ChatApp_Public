...
//  ChatApp
//
//  Created by Tsibulko on 29.03.2021.
//
...
class ChatsViewController: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        // to avoid extra indent (that left from hidden avatar image)
    ...
    } // end of private func insertNewMessage
    ...
    } // end of @objc func cameraButtonPressed()
        ...
        StorageService.shared.uploadImageMessage(photo: image, to: chat) { (result) in
            ...
            case .success(let url):
                ...
                FirestoreService.shared.sendMessage(chat: self.chat, message: imageMessage) { (result) in
                    ...
                    case .failure(_):
                        self.showAlert(with: "Oops", and: "Image was not delivered")
                    }
                }
            case .failure(let error):
                self.showAlert(with: "Oops", and: error.localizedDescription)
    ...
    } // end of  private func sendPhoto
    
    
} // end of class ChatsViewController
...
extension ChatsViewController {
    ...
    } // end of func configureMessageInputBar()
    ...
    } // end of func configureSendButton()
    
    
    func configureCameraIcon() {
        let cameraItem = InputBarButtonItem(type: .system)
        cameraItem.tintColor = #colorLiteral(red: 1, green: 0.5387238565, blue: 0.9453034519, alpha: 1)
    ...
    } // end of func configureCameraIcon()
...
} // end of extension ChatsViewController: MessagesDataSource
...
} // end of extension ChatsViewController: MessagesLayoutDelegate
...
} // end of extension ChatsViewController: MessagesDisplayDelegate
...
extension ChatsViewController: InputBarAccessoryViewDelegate {
    ...
    } // end of func inputBar
    
} // end of extension ChatsViewController: InputBarAccessoryViewDelegate
...
} // end of extension ChatsViewController: UINavigationControllerDelegate, UIImagePickerController
