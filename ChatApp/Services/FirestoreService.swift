...
class FirestoreService {
    ...
    } // end of func getWaitingChatMessages()
    ...
    func createActiveChat(chat: MChat, messages: [MMessage], completion: @escaping (Result<Void, Error>) -> Void) {
        ...
        } // end of activeChatsRef.document(.....)
    } // end of func createActiveChat
    ...
    } // end of func sendMessage()
    
    
} // end of class FirestoreService
